package com.alfrsms.and_ch7.main.ui.adapter
...
import com.alfrsms.and_ch7.databinding.MovieItemBinding
...
class HomeAdapter(private val movies: List<Data>) : RecyclerView.Adapter<HomeAdapter.HomeViewHolder>() {
    ...
    class HomeViewHolder(private var binding: MovieItemBinding) :
